...
import com.kingo.ar.screenshot.OnScreenshotListener;
import com.kingo.ar.screenshot.ScreenshotHelper;
import com.kingo.ar.sensor.BeyondarSensorManager;
import com.kingo.ar.util.math.geom.Ray;
import com.kingo.ar.view.BeyondarGLSurfaceView;
import com.kingo.ar.view.BeyondarViewAdapter;
import com.kingo.ar.view.CameraView;
import com.kingo.ar.view.OnClickBeyondarObjectListener;
import com.kingo.ar.view.OnTouchBeyondarViewListener;
 ...
 * 
 */
public class KingoArFragmentSupport extends Fragment implements FpsUpdatable, OnClickListener,
		OnTouchListener {
