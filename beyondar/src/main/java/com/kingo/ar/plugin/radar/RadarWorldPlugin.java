 ...
 */
package com.kingo.ar.plugin.radar;
...
import com.kingo.ar.plugin.WorldPlugin;
...
public class RadarWorldPlugin implements WorldPlugin, BeyondarSensorListener {
	...
	/**
	 * This method adds the {@link RadarPointPlugin} to the {@link GeoObject GeoObject}
	 * 
	 ...
	 * 
	 * @return max distance to render the {@link GeoObject GeoObject}s
	 */
