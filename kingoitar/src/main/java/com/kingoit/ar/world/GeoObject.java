...
public class GeoObject extends BeyondarObject {
	 ...
	 * 
	 * @param geo
	 *            The other {@link GeoObject GeoObject} to calculate the distance.
	 ...
	 * 
	 * @param longitude
	 *            The other {@link GeoObject GeoObject} longitude to calculate the
	 *            distance.
	 * @param latitude
	 *            The other {@link GeoObject GeoObject} latitude to calculate the
	 *            distance.
	 * @return The distance in meters.
	 */
