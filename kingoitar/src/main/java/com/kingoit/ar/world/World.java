...
public class World implements Plugable<WorldPlugin> {
     ...
     * @param beyondarObject
     */
    public synchronized void addBeyondarObject(BeyondarObject beyondarObject, int worldListType, int drawListType) {
        ...
        synchronized (mLock) {
            ...
            listTmp.setDrawType(drawListType);
            synchronized (lockplugins) {
                for (WorldPlugin plugin : plugins) {
